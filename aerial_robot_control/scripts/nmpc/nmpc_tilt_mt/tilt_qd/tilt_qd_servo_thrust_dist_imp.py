...
class NMPCTiltQdServoThrustImpedance(QDNMPCBase):
    """
    Controller Name: Tiltable Quadrotor NMPC including Servo and Thrust Model as well as CoG Disturbance and Impedance Cost function
