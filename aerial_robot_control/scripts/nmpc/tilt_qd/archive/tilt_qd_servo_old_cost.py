...
nmpc_param_path = os.path.join(rospack.get_path("beetle"), "config", "BeetleNMPCOldServoCost.yaml")
...
class NMPCTiltQdServoOldCost(NMPCBase):  # old cost means the quadrotor one, not ac_d.
    def __init__(self):
        super(NMPCTiltQdServoOldCost, self).__init__()
